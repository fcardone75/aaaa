...
//TODO: verificare naming permissions
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        yield Field::new('filenameFile', 'crud.report_import.grid.column_label.filename_file')
            ...
            ->setFormTypeOption('delete_label', 'Remove file')
            ->hideOnIndex()
            ->hideOnDetail();

// Add a separate field to display the filename
        yield TextField::new('filename', 'Current File')
            ->onlyOnForms()
...
//    }
    ...
    public function download(AdminContext $context,AdminUrlGenerator $adminUrlGenerator)
    {
        ...
        try {
            ...
            $this->addFlash('danger', 'Il file non è disponibile sullo storage.');
